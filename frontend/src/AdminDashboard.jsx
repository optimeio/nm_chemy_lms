...
export default function AdminDashboard() {
  ...
  // UPLOAD HACKATHON SLIDESHOW GALLERY IMAGES
    ...
    <div className="flex h-screen bg-slate-50 overflow-hidden font-sans">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto p-6 sm:p-8">
          ...
          {/* TAB 1: DASHBOARD METRICS & GALLERY */}
          {activeTab === 'dashboard' && (
                ...
                <div className="lg:col-span-7 bg-white rounded-3xl border border-slate-200 p-6 sm:p-8 space-y-6">
                  ...
                  <form onSubmit={handlePublishHackathon} className="space-y-4">
                    ...
                    <div className="border-t border-slate-100 pt-4 space-y-3">
                      <label className="block text-xs font-bold text-slate-700 uppercase text-left">Assignment Targeting Filters</label>
                      <div className="grid gap-4 sm:grid-cols-2">
                        <div>
